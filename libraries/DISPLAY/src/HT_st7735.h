...
#define ST7735_LED_K_Pin     Vext
#define ST7735_VTFT_CTRL_Pin  GPIO5
...
public:
	...
	void st7735_write_str(uint16_t x, uint16_t y, const char* str, FontDef font, uint16_t color, uint16_t bgcolor);
