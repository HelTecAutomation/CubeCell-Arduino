...
class DEPG0290BxS75AFxX_BW : public ScreenDisplay {
  private:
      uint8_t             _rst;
      uint8_t             _dc;
      int8_t              _cs;
  ...
  public:
    DEPG0290BxS75AFxX_BW(uint8_t _rst, uint8_t _dc, int8_t _cs, int8_t _busy, int8_t _sck, int8_t _mosi,int8_t _miso,uint32_t _freq = 6000000, DISPLAY_GEOMETRY g = 
GEOMETRY_296_128) {
        setGeometry(g);
      this->_rst = _rst;
      this->_dc  = _dc;
