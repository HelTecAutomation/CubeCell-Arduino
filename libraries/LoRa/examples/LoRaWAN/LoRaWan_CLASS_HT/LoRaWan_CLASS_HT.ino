...
uint32_t class_HT_cycle_time = 1000;
uint32_t class_HT_max_rxtime = 2000;
/*
...
/* OTAA para*/
uint8_t devEui[] = { 0x22, 0x32, 0x33, 0x00, 0x00, 0x99, 0x99, 0x06 };
...
uint16_t userChannelsMask[6]={ 0x0000,0x0000,0x2000,0x0000,0x0000,0x0000 };
